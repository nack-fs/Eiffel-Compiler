...
public class ComparisonExpression extends AbstractExpression  {
	...
	public ComparisonExpression(Object left, Object operator, Object right) {
		super();
    ...
    public String toString() {
        return "ComparisonExpression{" + " left=" + this.getLeft() + " operator=" + this.getOperator() + " right=" + this.getRight() + "}";
    }
